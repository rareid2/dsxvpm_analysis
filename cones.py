...
dd = dt.datetime(2020,6,1,1,46,50,tzinfo=dt.timezone.utc)
tt_increment = [0,20,40,60,80]

"""
# this is all to get avg time --- comment this out
ray_datenum = dd + dt.timedelta(seconds=0)
...
for tti in tt_increment:
    ray_datenum = dd + dt.timedelta(seconds=tti)
